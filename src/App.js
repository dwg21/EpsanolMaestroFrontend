import {Navbar2, Conjugation, Translator, Home, Story, VocabularyForm, Past, Subjunctive, Future, Login, LogOutPage} from './components/index';
      ...
      <Box sx = {{backgroundColor: 'white', height: '100vh'}} height = '100%' >
        <Navbar2/>
          ...
          <Route exact path = '/'  element = {<Login />} />
            ...
            <Route exact path = '/logedout' element  = {<LogOutPage />} />
