    ...
    <Box p = {2} >
      ...
      <FormControl fullWidth sx = {{marginBottom: '2rem'}}>
        ...
        >
          ...
          <button className = 'button' onClick={handleStartExcercise} >
            Start Drill
          </button>
        ...
        {userData.vocabularyCount? <Counter title ='Words Learnt So Far' value={userData.vocabularyCount.length}/> : ''}
          <div className='wordlist'>
            {userData.vocabularyCount && userData.vocabularyCount.map((word, i) => (
              <>
