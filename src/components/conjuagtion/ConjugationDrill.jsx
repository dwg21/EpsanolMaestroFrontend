...
const ConjugationDrill = ({questionQuantity, verbs, tense, setConjugationFormActive}) => {
    ...
    const [showFeedback, setShowFeedback] = useState(false)
        ...
        const updateConjuagtionCount = async (CorrectAnswerResult) => {
            const ConjugationCountUpdate = {
                "verbsConjuagted" : CorrectAnswerResult
            }

            console.log(ConjugationCountUpdate)
    ...
    const submitAnswer = () => {
        ...
        if (answer === expectedAnswer) {
            ...
            if (questionCounter === questionQuantity - 1 ) {
                updateConjuagtionCount(questionCounter - incorrectAnswers.length)  
                }
